const data = [
  { text: "Historia del Tenis: Un Legado Centenario.", id: "historia" },
  { text: "Los Grand Slam: La Cima del Éxito Tenístico.", id: "los" },
  { text: "Las Asociaciones ATP y WTA: El Camino hacia la Grandeza.", id: "las" },
  { text: "Jugadores Icónicos: Leyendas de la Cancha.", id: "jugadores" },
