const data = [
  { text: "Historia del Béisbol", id: "historia" },
  { text: "Reglas Básicas del Béisbol", id: "reglas" },
  { text: "Major League Baseball (MLB)", id: "major" },
  { text: "Otras Ligas Importantes", id: "otras" },
  { text: "Estrellas del Béisbol", id: "estrellas" },
  { text: "Desarrollo y Futuro del Béisbol", id: "desarrollo" },
