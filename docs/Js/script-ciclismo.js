const data = [
  { text: "Historia del Ciclismo.", id: "historia" },
  { text: "Disciplinas del Ciclismo.", id: "disciplinas" },
  { text: "Ciclismo de Pista.", id: "ciclismo" },
  { text: "Grandes Vueltas.", id: "grandes" },
  { text: "Reglas Básicas del Ciclismo.", id: "reglas" },
  { text: "Equipos y Estrellas del Ciclismo.", id: "equipos" },
  { text: "Desarrollo y Futuro del Ciclismo..", id: "desarrollo" },
