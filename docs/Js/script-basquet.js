const data = [
  { text: "Historia del Baloncesto", id: "historia" },
  { text: "Reglas Básicas del Baloncesto", id: "reglas" },
  { text: "NBA: La Liga de Baloncesto Más Prestigiosa", id: "nba" },
  { text: "Euroliga: La Máxima Competición Europea", id: "euroliga" },
  { text: "Estrellas Internacionales del Baloncesto", id: "estrellas" },
  { text: "Desarrollo y Futuro del Baloncesto", id: "desarrollo" },
