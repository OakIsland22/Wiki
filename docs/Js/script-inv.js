const data = [
  { text: "Historia de los Deportes de Invierno.", id: "historia" },
  { text: "Disciplinas de Deportes de Invierno.", id: "disciplinas" },
  { text: "Juegos Olímpicos de Invierno.", id: "juegos" },
  { text: "Desarrollo y Futuro de los Deportes de Combate.", id: "desarrollo" },
  { text: "Conclusión", id: "conclucion" },
];

const mainOptions = [
  { text: "Historia de los Deportes de Combate.", id: "historia" },
  { text: "Disciplinas de Deportes de Combate.", id: "disciplinas" },
  { text: "Desarrollo y Futuro de los Deportes de Combate.", id: "desarrollo" },
];
