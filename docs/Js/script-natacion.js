const data = [
  { text: "Historia del Fútbol.", id: "historia" },
  { text: "Récords Mundiales.", id: "records" },
  { text: "Competiciones Importantes.", id: "ligas" },
  { text: "Nadadores Destacados.", id: "equipos" },
  { text: "Conclusión", id: "conclucion" },
];

const mainOptions = [
  { text: "Historia del Fútbol.", id: "historia" },
  { text: "Récords Mundiales.", id: "reglas" },
  { text: "Competiciones Importantes.", id: "ligas" },
];
